...
from examples.stg.dm_timestamps_dag.timestamps_loader import DmTimestampsLoader
...
def sprint5_example_dds_dm_timestamps_dag():
    ...
    def load_dm_timestamps():
        ...
        rest_loader = DmTimestampsLoader(dwh_stg_pg_connect, dwh_dds_pg_connect, log)
...
stg_dds_dm_timestamps_dag = sprint5_example_dds_dm_timestamps_dag()
