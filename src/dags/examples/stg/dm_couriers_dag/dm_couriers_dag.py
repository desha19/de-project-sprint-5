...
from examples.stg.dm_couriers_dag.couriers_loader import DmCouriersLoader
...
def sprint5_example_dds_dm_couriers_dag():
    ...
    def load_dm_couriers():
        ...
        rest_loader = DmCouriersLoader(dwh_stg_pg_connect, dwh_dds_pg_connect, log)
...
stg_dds_dm_orders_dag = sprint5_example_dds_dm_couriers_dag()
