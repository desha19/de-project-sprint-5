...
from examples.stg.dm_restaurants_dag.restaurants_loader import DmRestaurantsLoader
...
def sprint5_example_dds_dm_restaurants_dag():
    ...
    def load_dm_restaurants():
        ...
        rest_loader = DmRestaurantsLoader(dwh_stg_pg_connect, dwh_dds_pg_connect, log)
    ...
    dm_restaurants_dict  # type: ignore


stg_dds_dm_restaurants_dag = sprint5_example_dds_dm_restaurants_dag()
