...
from examples.stg.dm_settlement_report_dag.settlement_report_loader import DmSettlementReportLoader
...
def sprint5_example_cdm_dm_settlement_report_dag():
    ...
    def load_dm_settlement_report():
        ...
        rest_loader = DmSettlementReportLoader(dwh_stg_pg_connect, dwh_dds_pg_connect, log)
        rest_loader.load_dm_settlement_report()  # Вызываем функцию, которая перельет данные.

    # Инициализируем объявленные таски.
    dm_users_dict = load_dm_settlement_report()
...
stg_cdm_dm_users_dag = sprint5_example_cdm_dm_settlement_report_dag()
