...
from examples.stg.dm_users_dag.users_loader import DmUserLoader
...
def sprint5_example_dds_dm_users_dag():
    ...
    def load_dm_users():
        ...
        rest_loader = DmUserLoader(dwh_stg_pg_connect, dwh_dds_pg_connect, log)
...
stg_dds_dm_users_dag = sprint5_example_dds_dm_users_dag()
